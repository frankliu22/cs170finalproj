...
def solve(G):
    """
    Similar to Nick's Prim's approach but presorts the dominating set of vertices by distance away from a randomly chosen start vertex.
    Also calls extra-vertex-optimization in the end.
    Args:
        G: networkx.Graph
